  ...
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>
          --Real-time Data Integration**: Leveraging WebSocket APIs to fetch
          live market data, such as order books, price ladders, and top-of-book
          information for various cryptocurrency pairs.{" "}
        </li>
        <br />
        <li>
          --Interactive Visualizations**: Implementing widgets like price
          charts, currency pair selectors, and dynamic tables to represent
          market data effectively.{" "}
        </li>
        <br />
        <li>
          --State Management**: Using Redux to ensure smooth data flow and
          manage complex application states efficiently.{" "}
        </li>
        <br />
        <li>
          --Adaptive Design**: Ensuring the app is fully responsive and
          provides a seamless user experience across different devices.{" "}
        </li>
        <br />
      </ul>
      <p>
